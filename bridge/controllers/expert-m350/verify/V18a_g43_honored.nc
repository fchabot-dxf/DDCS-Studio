...
(BEFORE RUNNING: set param #400 to 10.000 on the Param page, and write down the Z readings.)
...
(Read H01 back through the macro address V6 confirmed)
#101 = #900

#1510 = #101
#1505 = -5000(V18a H01=%.3f applying G43 H1)
G04 P3.0

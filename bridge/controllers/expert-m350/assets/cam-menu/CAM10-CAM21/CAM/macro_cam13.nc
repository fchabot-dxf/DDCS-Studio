(Find outer corner with 3D touch probe)
(v1.0)
...
G53 Z#12	;	safe Z
G91 G31 Y[#2*#7*-1] F[#3*3] P#30 L#31 Q1  ;move back
IF #1921==2 GOTO3  ;Collision

G91 G31 Z#5 F#3 P#30 L#31 Q1  ;Scanning height
IF #1922==2 GOTO3  ;Collision

G91 G31 Y[#2*#7] F#3 P#30 L#31 Q1  ;fast scan
IF #1921==0 GOTO1  ;edge not found!
#22=#1926  ;edge found

G53 Y[#22-[#15*#7]]   ;отскок
G91 G31 Y[#15*2*#7] F#14 P#30 L#31 Q1  ;Scanning
IF #1921==0 GOTO1  ;edge not found!
...
G53 Z#12	;	safe Z
G91 G31 X-[#1*#6] F[#3*3] P#30 L#31 Q1  ;move back
IF #1920==2 GOTO3  ;Collision

G91 G31 Z#5 F#3 P#30 L#31 Q1  ;Scanning height
IF #1922==2 GOTO3  ;Collision

G91 G31 X[#1*#6] F#3 P#30 L#31 Q1  ;fast scan
IF #1920==0 GOTO1  ;edge not found!
#20=#1925  ;Edge found

G53 X[#20-[#15*#6]]   ;отскок
G91 G31 X[#15*2*#6] F#14 P#30 L#31 Q1  ;Scanning
IF #1920==0 GOTO1  ;edge not found!

...
Guard: `blocks/programModel.js:407` (t1928 — shifted from 388 by +19; previously stale at 236, then 269, then 347, then 357, then 364) — subscriber isolation logs `console.error`, never a bare `catch {}`. Both of

...
### 8 · The z-index comment in `createPreviewPanel.js:1124-1125` describes code that no longer runs.
It says the 3D canvas is z-index 2 above the 2D canvas. The only code that sets that is `gcodeViz3d.js:2803`

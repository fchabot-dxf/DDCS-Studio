...
export const surfacingView = {
    ...
    update(ctx) {
        ...
        ctx.preview3D(gcode, 'surfacingVizContainer', undefined, undefined, undefined, undefined, { opType: 'surfacing', params });   // t2176 — BACKLOG 10: whole-program context (editing splices in place; a new op previews appended at the end)

...
const G = {
    ...
    // t708 — braces so a literal {SN}/{DATE} token RENDERS as text in stage 1 (stage 2 owns the dynamic substitution).
    '{': { w: 3.2, s: [[[2.4, 7], [1.3, 6.3], [1.3, 4.3], [0.3, 3.5], [1.3, 2.7], [1.3, 0.7], [2.4, 0]]] },
    '}': { w: 3.2, s: [[[0.6, 7], [1.7, 6.3], [1.7, 4.3], [2.7, 3.5], [1.7, 2.7], [1.7, 0.7], [0.6, 0]]] },
};

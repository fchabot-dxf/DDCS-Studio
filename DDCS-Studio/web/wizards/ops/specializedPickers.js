...
export const cornerGridPickerBlock = {
    type: 'corner_grid_picker', label: '3x3 datum grid', category: 'Wizard UI',
...
export const regionPickFieldBlock = {
    type: 'region_pick_field', label: 'region/plane picker', category: 'Wizard UI',
...
export const toolLibraryPickerBlock = {
    type: 'tool_library_picker', label: 'tool picker (with ⚙)', category: 'Wizard UI',
...
export const threadPresetPickerBlock = {
    type: 'thread_preset_picker', label: 'thread/pitch picker', category: 'Wizard UI',
...
export const declaredIoPickerBlock = {
    type: 'declared_io_picker', label: 'controller I/O picker', category: 'Wizard UI',
...
export const sliderFieldBlock = {
    type: 'slider_field', label: 'range slider', category: 'Wizard UI',
...
export const stepperFieldBlock = {
    type: 'stepper_field', label: 'stepper input', category: 'Wizard UI',

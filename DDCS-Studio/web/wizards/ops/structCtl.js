...
export const STRUCT_CTL_BLOCKS = [
    ...
    enu('travelShape', 'Travel shape', 'dogleg', [['Dogleg', 'dogleg'], ['Diagonal', 'diagonal']], 'Dogleg = the tool routes around the corner (two axis moves) — never passes over the stock; Diagonal = a single straight move across at your Safe Z — faster, but relies on your Safe Z clearing the stock top.'),   // t328 — mirrors CORNER_STRUCT_BINDINGS travelShape (label/help/options/default asserted 1:1 by corner-structctl)

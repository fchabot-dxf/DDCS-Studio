...
export const formDropdownBlock = {
    type: 'form_dropdown', label: 'dropdown field', category: 'Wizard UI',
...
export const formCheckboxBlock = {
    type: 'form_checkbox', label: 'toggle field', category: 'Wizard UI',
...
export const formSegmentedBlock = {
    type: 'form_segmented', label: 'segmented picker', category: 'Wizard UI',
...
export const formDiagramBlock = {
    type: 'form_diagram', label: 'inline diagram', category: 'Wizard UI',
...
export const formActionBtnBlock = {
    type: 'form_action_btn', label: 'action button', category: 'Wizard UI',

...
export const surfaceFillBlock = {
    ...
    defaults: { shape: 'rect', x: 0, y: 0, w: 100, h: 80, stepover: 7.2, strategy: 'parallel', direction: 'bothways', z: 'z', feed: 800, plunge: 200, clearance: 5 },
    fields: ['shape', 'x', 'y', 'w', 'h', 'stepover', 'strategy', 'direction', 'z', 'feed', 'plunge', 'clearance'],

...
import { sim3dBoxBlock, layout2dCanvasBlock, codePreviewPanelBlock, shapeRectBlock, shapeCircleBlock, shapeLineBlock, shapeMarkerBlock } from './vizBlocks.js';   // t1627 — + the four 2D shape primitives (Wizard Shapes)
...
export const PALETTE = [
    ...
    paramBlock, regionPickBlock, coordListBlock, panelBlock, layoutBlock, splitHorizontalBlock, splitVerticalBlock, gridContainerBlock, tabGroupBlock, tabPageBlock, groupBoxBlock, formDropdownBlock, formCheckboxBlock, formSegmentedBlock, formDiagramBlock, formActionBtnBlock, sim3dBoxBlock, layout2dCanvasBlock, codePreviewPanelBlock, shapeRectBlock, shapeCircleBlock, shapeLineBlock, shapeMarkerBlock, cornerGridPickerBlock, regionPickFieldBlock, toolLibraryPickerBlock, threadPresetPickerBlock, declaredIoPickerBlock, sliderFieldBlock, stepperFieldBlock, simBlock, simStartBlock, formFieldBlock, layoutWidgetBlock, userRootBlock, sectionBlock, opUnitBlock, ...STRUCT_CTL_BLOCKS, // Wizard UI (GUI param knob + region-pick + coordinate-list + panel-type + layout-splitters + grid/tab/card containers + dropdown/toggle/segmented controls + SVG diagrams + preview boxes + 3x3 datum grid + region/tool/thread/IO pickers + slider/stepper inputs + preview-rig + per-pass sim-start declarations + FORM value-field blocks + LAYOUT-2D widget blocks + titled concern-section + declared sub-unit boundary + structural-control blocks)

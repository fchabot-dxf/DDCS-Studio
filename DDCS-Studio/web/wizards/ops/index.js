...
import { safeRetractBlock, safeTraverseBlock } from './saferetract.js';   // t822 — the shared machine-frame SAFE-HEIGHT retract; t901 — the safetraverse BUNDLE atom (lift+travel+return)
...
export const PALETTE = [
    ...
    moveBlock, arcBlock, probeBlock, machineMoveBlock, safeRetractBlock, safeTraverseBlock, homeBlock, pathModeBlock,   // Move (+ G53 machine-coord move + machine-frame safe-Z retract + safetraverse bundle + G28 home + G64/G61 path mode)

...
export const MIDDLE_BINDING_SPECS = [
    ...
    { param: 'safeZ',     type: 'number', default: MIDDLE_DEFAULTS.safeZ,     label: 'Safe Z',         help: 'How far the probe lifts (incremental) to jog clear between walls — clear of the pocket lip / boss top.', section: 'GEOMETRY',   match: { type: 'assign', var: '#17' }, key: 'value' },

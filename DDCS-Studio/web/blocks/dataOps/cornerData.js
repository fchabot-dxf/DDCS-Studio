...
export const CORNER_BINDING_SPECS = [
    ...
    { param: 'planeZ',    type: 'number', default: CORNER_DEFAULTS.planeZ,    label: 'Clearance Plane (work Z)', help: 'Plane mode: an absolute WORK-Z the probe clears to (fixtures / tall stock). A WORK Z — set the Z datum first.', section: 'GEOMETRY', when: { param: 'clearMode', is: 'plane' }, match: { type: 'clearlift' }, key: 'planeZ' },

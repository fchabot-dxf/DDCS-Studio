...
export const CORNER_STRUCT_BINDINGS = [
    ...
    { param: 'travelApproach', type: 'enum', widget: 'segmented', default: CORNER_DEFAULTS.travelApproach, label: 'Travel', help: 'Auto = the machine moves itself between the walls; Manual = you jog to each start and press Cycle Start (operator-in-the-loop).', section: 'GEOMETRY', widgetConfig: { options: [['Auto', 'auto'], ['Manual', 'manual']] } },   // t323 — opt-in segmented [Auto|Manual]

...
const BORE_EXEC_BINDINGS = [
    ...
    { param: 'rows', blockIndex: 3, key: 'rows', type: 'number', default: BORE_DEFAULTS.rows },
    { param: 'dx', blockIndex: 3, key: 'dx', type: 'number', default: BORE_DEFAULTS.dx },
    { param: 'dy', blockIndex: 3, key: 'dy', type: 'number', default: BORE_DEFAULTS.dy },
    { param: 'count', blockIndex: 3, key: 'count', type: 'number', default: BORE_DEFAULTS.count },
    { param: 'spacing', blockIndex: 3, key: 'spacing', type: 'number', default: BORE_DEFAULTS.spacing },
    { param: 'angle', blockIndex: 3, key: 'angle', type: 'number', default: BORE_DEFAULTS.angle },
    { param: 'dia', blockIndex: 3, key: 'dia', type: 'number', default: BORE_DEFAULTS.dia },
    { param: 'startAngle', blockIndex: 3, key: 'startAngle', type: 'number', default: BORE_DEFAULTS.startAngle },
    { param: 'w', blockIndex: 3, key: 'w', type: 'number', default: BORE_DEFAULTS.w },
    { param: 'h', blockIndex: 3, key: 'h', type: 'number', default: BORE_DEFAULTS.h },
    { param: 'nx', blockIndex: 3, key: 'nx', type: 'number', default: BORE_DEFAULTS.nx },
    { param: 'ny', blockIndex: 3, key: 'ny', type: 'number', default: BORE_DEFAULTS.ny },

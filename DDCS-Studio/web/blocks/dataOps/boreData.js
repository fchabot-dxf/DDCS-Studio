...
const BORE_EXEC_BINDINGS = [
    ...
    { param: 'dia', help: "Bolt-circle diameter — holes sit evenly on this circle.", blockIndex: 3, key: 'dia', type: 'number', default: BORE_DEFAULTS.dia, when: { param: 'pattern', is: 'circle' }, label: 'Circle Ø', section: 'GEOMETRY' },
    ...
    { param: 'holeDia', help: "Target bored hole Ø (mm) — must be ≥ the tool Ø.", blockIndex: 4, key: 'holeDia', type: 'number', default: BORE_DEFAULTS.holeDia, label: 'Hole Ø', section: 'TOOL & CUT' },

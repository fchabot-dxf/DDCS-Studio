...
export const SCHEMA = {
    ...
    middle: {
        ...
        clearOver: N(), crossX: Str(), crossY: Str(), f_fast: N('F', 'feedFast'), f_slow: N('F', 'feedSlow'), port: N(), syncA: Bool(), slave: Enum(), qStop: N(),
    },
    corner: {
...
const FIELD_BIND = {
    ...
    middle: { featureType: 'm_type', approach: 'm_approach', clearOver: 'm_clear', crossX: 'm_crossX', crossY: 'm_crossY', axis: 'm_axis', findBoth: 'm_both', circular: 'm_circular', syncA: 'm_sync_a', slave: 'm_slave', wcs: 'm_wcs', dist: 'm_dist', retract: 'm_retract', safeZ: 'm_safe_z', f_fast: 'm_feed_fast', f_slow: 'm_feed_slow', qStop: 'm_q', dir1: 'm_dir', dir2: 'm_dir2' },

                ...
                <div style="display:flex; gap:6px; width:auto; align-items:center;">
                    ...
                    <div class="toolbar-dropdown">
                        ...
                        <div class="toolbar-dropdown-content">
                            ...
                            <button onclick="openWiz && openWiz('bore')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="vertical-align:-2px;margin-right:3px;"><circle cx="12" cy="12" r="8.5" stroke="#94a3b8" stroke-width="2.5"/><circle cx="12" cy="12" r="4" stroke="#94a3b8" stroke-width="1.6" fill="#1e293b"/></svg>Bore (helical)</button>

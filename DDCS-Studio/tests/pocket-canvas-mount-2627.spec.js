...
/**
 * t2627 (BACKLOG #71/#72, pocket migration) — REAL-SYMPTOM supplement to
 * `pocket-form-reproduction-2301.spec.js` (which the shared `formReproduction.js` harness already covers for
 ...
 * `pocketData`/`POCKET_DATA_OPTYPE`/`user_pocket_data` before calling this migration verified.
 */
test('pocket-canvas-mount: the feature canvas mounts a REAL 2D/3D pane, no unwired placeholder', async ({ page }) => {

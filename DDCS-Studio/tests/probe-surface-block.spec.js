...
// CORNER migration (t127) — 3 touches (X/Y/Z) compose probeSurfaceStack; golden captured pre-migration, REGENERATED at
// t897 (the crash-adjacent lift/drop fix: each wall's probeWallR SAVES the pre-lift Z `#95=#882` before the G53 lift and
// the wall1->wall2 traverse RETURNS to it `G90 / G53 Z#95 / G91`), and t899 (REGISTER-OWNERSHIP: the safeRetract guard is
// READ-ONLY to #520 — `#42=#520` / `IF #42<0` / `#42=-5` / `G53 Z#42`, never `#520=`). t899 diff-verified: ONLY the guard
// lines changed (#520 -> the #42 scratch read/fallback/move, 3 guards/corner); the t897 save/return lines are UNTOUCHED.

...
// t897 (the crash-adjacent lift/drop fix): each wall's probeWallR now SAVES the pre-lift Z (#95=#882, before the G53
// margin lift) and the wall1->wall2 traverse RETURNS to it (G90 / G53 Z#95 / G91) instead of the old relative drop
// (G0 Z[0-#19] / G0 Z#18). Verified by diff: ONLY the save/return lines changed (2 saves per corner — wall-2's is a
// harmless unpaired scratch; 1 return); the resulting Z is proven in lift-drop-pairing-897.

...
const INVARIANT_CLAIMS = [
    ...
    { id: 'INV3 subscriber isolation logs, never swallows', file: 'web/blocks/programModel.js', line: 518, find: /console\.error/ },   // t1958 — shifted from 472 by +46 (findOpById + replaceOpById declared beside flattenOps, then findOpInStack's deepest-match-first reorder)

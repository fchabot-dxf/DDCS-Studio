...
const TRAP_CLAIMS = [
    ...
    { id: 'TRAP7 commandDeck stamps type||opensAs||id', file: 'web/ui/commandDeck.js', line: 105, find: /opensAs/ },   // t1910 — shifted from 103 by +2 (new HEADER_ICONS.lathe entry + comment)

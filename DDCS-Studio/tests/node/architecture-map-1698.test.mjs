...
const TRAP_CLAIMS = [
    ...
    { id: 'TRAP6 homingData.js passes setup_datawiz', file: 'web/blocks/dataOps/homingData.js', line: 161, find: /setup_datawiz/ },
...
const INVARIANT_CLAIMS = [
    ...
    { id: 'INV6 hookKeysOf derives from one real constructor call', file: 'web/blocks/userOps.js', line: 839, lineEnd: 841, find: /_BASE_DEF_SHAPE|hookKeysOf/ },
    ...
    { id: 'INV13 FAIL CLOSED return null', file: 'web/blocks/userOps.js', line: 1091, find: /return null/ },
    { id: 'INV14 postInstantiate ordering', file: 'web/blocks/userOps.js', line: 911, find: /postInstantiate/ },
...
const Q3_CLAIMS = [
    ...
    { id: 'Q3 lathe spec carries no placement key (early-return)', file: 'web/wizards/ops/panelTypes.js', line: 173, lineEnd: 174, find: /latheLayoutSpec/ },
];

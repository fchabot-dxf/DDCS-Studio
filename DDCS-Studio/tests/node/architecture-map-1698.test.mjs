...
const TRAP_CLAIMS = [
    ...
    { id: 'TRAP8 the stale z-index comment', file: 'web/viz/createPreviewPanel.js', line: 1124, lineEnd: 1125, find: /z-index/ },   // t1850 — shifted from 1121-1122 by the setStarts()-wiring edit above it
    { id: 'TRAP8 .attach( only caller is the retired bak file', file: 'web/viz/gcodeViz3d.js', line: 2803, find: /attach/ },   // t1850 — shifted from 2779 by the new setStarts() method + _ensureMarkers/setSegments edits above it

...
const INVARIANT_CLAIMS = [
    ...
    { id: 'INV3 subscriber isolation logs, never swallows', file: 'web/blocks/programModel.js', line: 472, find: /console\.error/ },   // t1950 — shifted from 456 by +16 (regroupOps split into a shape-only function + its own corrected doc comment)

...
const TRAP_CLAIMS = [
    ...
    { id: 'TRAP4 RESOLVED — the emit is unconditionally flush-left now, no settings, no per-dialect branch', file: 'web/blocks/blockEmitter.js', find: "for (const t of T) if (t && typeof t.line === 'string') t.line = t.line.replace(/^[ \\t]+/, '');" },

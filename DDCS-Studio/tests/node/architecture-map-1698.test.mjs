...
const TRAP_CLAIMS = [
    ...
    { id: 'TRAP6 commData.js passes setup_datawiz', file: 'web/blocks/dataOps/commData.js', find: "const def = userOpFromStack('comm_data', 'Communication (data)', stack, bindings, 'commscreen', {}, 'setup_datawiz');" },

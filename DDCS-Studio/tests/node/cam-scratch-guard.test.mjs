...
// call generator/guard functions, and assert on plain returned data — no DOM read, no click, no screenshot. The file's
// third test (drives the real CAM authoring modal via window.ddcsOpenCamAuthoring/page.click/localStorage read-back)
// depends on the real DOM — not a candidate for this tier. Split into tests/cam-scratch-guard-drive.spec.js.

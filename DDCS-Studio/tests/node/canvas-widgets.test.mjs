 ...
 *
 * t1512 (tier migration): SPLIT off browser→node. The 5 tests here are pure drag-MATH — buildCanvasWidgets returns
 * plain handle/onDrag/onEdit data, asserted directly, no DOM/canvas/render. The 2 real-render tests (drill/text wizard
 * canvas handle counts, which open a live wizard and query rendered DOM) stayed in canvas-widgets-drive.spec.js.
 */

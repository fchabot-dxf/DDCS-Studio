...
/**
 * t2625 (BACKLOG #71/#72, slot migration) — REAL-SYMPTOM supplement to
 * `slot-form-reproduction-2375.spec.js` (which the shared `formReproduction.js` harness already covers for
 ...
 * `slotData`/`SLOT_DATA_OPTYPE`/`user_slot_data` before calling this migration verified.
 */
test('slot-canvas-mount: the feature canvas mounts a REAL 2D/3D pane, no unwired placeholder', async ({ page }) => {

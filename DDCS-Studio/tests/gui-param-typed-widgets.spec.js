 ...
 * preset from its `options` list ("Rough=500, Finish=1500"); toggle = 1/0. Locks: the widget dropdown offers the
 * four choices, parseParamOptions + extractParamBlocks derive the right binding, the form renders the right
 * control and commits a number, and the dropdown pill actually DRAWS in a socket (Class-B render guard).
 */

...
Cloudflare Pages serves `DDCS-Studio/web/` directly (Git integration, no
...
`npm run build:standalone` bundles the whole app into one `output/ddcs-studio-standalone.html`

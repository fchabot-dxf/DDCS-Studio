// svg-map-generator.cjs
// Usage: node scripts/svg-map-generator.cjs <input-svg> <output-md>
// Example: node scripts/svg-map-generator.cjs ../src/assets/middleViz.svg ../docs/middleViz_map.md
//
...
function main() {
  ...
  if (!inputSvg || !outputMd) {
    console.error('Usage: node scripts/svg-map-generator.cjs <input-svg> <output-md>');
    process.exit(1);
  }
